...
// +----------------------------------------------------------------------+
//
// $Id: Common.php 149 2008-11-26 02:45:38Z jantman $
...
// global $commentedOutGlobal;

/*
global $globalInMultilineComment;
 */

global $firstGlobal;
global $secondGlobal, $thirdGlobal;

function thisFunctionNotUsed()
{
    echo;
}

function definedUsedInOtherFile()
{
    echo;
}
...
{
    global $globalInChowCurrentMonth;
    echo;
    global $SecondGlobalInChowCurrentMonth;
}
