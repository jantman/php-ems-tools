/*
 ...
 +--------------------------------------------------------------------------------------------------------+
 | Time-stamp: "2010-08-25 23:17:16 jantman"                                                              |
 +--------------------------------------------------------------------------------------------------------+
...
/**
 * Functions related to call location stuff.
 *
 * @package MPAC-NewCall-JS
 */

/**
 * Changes which Call Location fields are displayed when cl_AddressState dropdown is changed.
 *
 * Called from cl_AddressState onChange() in HTML.
 *
 */
...
/**
 * Changes which cl_Address Divs are dis
 *
...
/**
 * Update which street options are shown depending on whether city is Midland Park or not.
 *
 * Called from HTML onChange() event.
 *
 */
...
/**
 * Handler for clicks on the Find Call Location link.
 *
 * Calls {@link newFindCallLocFormRequest()} with argument of {@link findCallLoc.php} for form.
 *
 */
...
/**
 * Fire HTTP Request for call location form.
 *
 * Called by {@link findCallLoc()} in JS.
 * Form is generated by {@link findCallLoc.php}
 * Callback handler is {@link handleNewFindCallLocFormRequest()}
 *
 * @param string $url the url to HTTP Request
 */
...
/**
 * Callback handler for {@link newFindCallLocFormRequest()}, displays Find Call Location form as DHTML popup.
 *
 * Callback handler for {@link newFindCallLocFormRequest()}.
 * Form content should be generated by {@link findCallLoc.php}
 *
 */
