...
<?php echo '<title>'.$shortName.' - Attendance</title>'; ?>
<link rel="stylesheet" href="../../php_ems.css" type="text/css">
</head>

<body>
<?php echo '<h1>'.$shortName.' - Attendance</h1>'; ?>

<ul>
<li><a href="listAttendance.php">List Attendance</a></li>
<li><a href="attendance.php">Take Attendance</a></li>
<li><?php echo '<a href="'.'yearlyAttendance.php?year='.date("Y").'">'.'Yearly Attendance'.'</a>';?></li>
</ul>
