...
/*
 ...
 +--------------------------------------------------------------------------------------------------------+
 | Time-stamp: "2010-08-25 15:24:28 jantman"                                                              |
 +--------------------------------------------------------------------------------------------------------+
 ...
 */
  ...
  /**
   * Get array of EMTid's for duty crew at a given TS
   *
   * This is just a test {@link getDutyCrew()}
   *
   * @param int $ts integer timestamp
   * @return array
   */
